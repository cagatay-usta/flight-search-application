  ...
  return (
    <div className="input-container flex-col flex relative flex-grow flex-shrink min-w-[205px]">
      ...
      {open && !oneWay && (
        <DayPicker
          mode="single"
          numberOfMonths={width.current > 720 ? 2 : 1}
          ...
          className={`absolute  ${
            width.current < 720 ? "-left-12 top-12" : "-left-48 top-16"
          } bg-slate-500 text-white p-6 rounded-xl z-10 shadow-xl`}
        />
      )}
    </div>
  );
